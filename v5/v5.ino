...
// LED pin configuration - LED moved to pin 2
const int led1 = A0;
const int led2 = A1;
const int led3 = A2;
const int led4 = 2;  // Changed from A3 to pin 2
...
// Word array (simplified to 12 words as per your wordCount)
const char* words[] = {
...
void lightRandomLED() {
  ...
  switch(currentLed) {
    ...
    case 2:
      ...
      break;
    case 3:
      digitalWrite(led4, HIGH); // Now pin 2
...
void turnOffAllLEDs() {
  ...
  digitalWrite(led4, LOW); // Now pin 2
}
...
void updateScoreDisplay() {
  ...
  // Clean format with good spacing
  lcd.setCursor(0, 1);
  lcd.print("V");
  printScore(scoreV);
